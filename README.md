...
The source code can be obtained via the Code Ocean repository link. The GitHub repository will be made public after the article is published.
...
click "Open file" to select the branching database of glycan chains(in StrucGP1.3-beta folder).
